      ...
      <div className="mt-6 space-y-4">
        ...
        {sent ? (
          ...
          <>
            {isGoogleConfigured() && (
              <>
                <a href="/auth/google" className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 font-medium text-gray-800 hover:bg-gray-50">
                  <GoogleMark />
